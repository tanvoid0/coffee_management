...
public class CoffeePage extends PageLayout {
    ...
    CoffeePage()
    {
        ...
        l2 = new JLabel("Menu Showing :Coffee!");
        ...
        //panel 3  image
        l3 = new JLabel(new ImageIcon(getClass().getResource("/images/coffee.png")));
        l3.setBounds(100,100,155,210);
        P3.add(l3);

        l4 = new JLabel(new ImageIcon(getClass().getResource("/images/coffee.png")));
        l4.setBounds(450,100,155,210);
        P3.add(l4);


        l5 = new JLabel(new ImageIcon(getClass().getResource("/images/coffee.png")));
        l5.setBounds(100,270,155,210);
        P3.add(l5);


        l6 = new JLabel(new ImageIcon(getClass().getResource("/images/coffee.png")));
